...
# SỬA LỖI 2: Thêm plugin này (phải chạy TRƯỚC plugin JWT)
# Sao chép header 'Authorization' gốc sang 'X-Auth-Token'
# echo ">>> Applying Request Transformer to copy Auth header..."
...
# SỬA LỖI 3: Mở comment và cấu hình JWT
# Cấu hình Kong đọc 'X-Auth-Token' thay vì 'Authorization'
...
# --- (Rate Limiting và các plugin khác giữ nguyên) ---
