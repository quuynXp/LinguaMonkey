...
public class NotificationI18nUtil {
    ...
    // Sửa lỗi: Sử dụng Map.ofEntries() với các đối tượng Map.entry()
    private static final Map<String, Map<String, String[]>> MESSAGES = Map.ofEntries(
            // Tiêu đề (0) | Nội dung (1)

            // --- FLASHCARD_REMINDER ---
            Map.entry("FLASHCARD_REMINDER", Map.of(
            ...
            Map.entry("DAILY_CHALLENGE", Map.of(
            ...
            Map.entry("DAILY_CHALLENGE_SUGGESTION", Map.of(
            ...
            Map.entry("DAILY_CHALLENGE_REMINDER", Map.of(
            ...
            // --- LEADERBOARD (Rank 1) ---
            Map.entry("LEADERBOARD_RANK1", Map.of(
            ...
            Map.entry("LEADERBOARD_OTHER", Map.of(
            ...
            // --- COURSE_UPDATE ---
            Map.entry("COURSE_UPDATE", Map.of(
            ...
            // --- STREAK_REMINDER ---
            Map.entry("STREAK_REMINDER", Map.of(
            ...
            Map.entry("THUMBNAIL_COURSE_READY", Map.of(
            ...
            Map.entry("THUMBNAIL_LESSON_READY", Map.of(
