...
public class CourseServiceImpl implements CourseService {
    ...
    public Page<CourseResponse> getAllCourses(String title, String languageCode, Pageable pageable) {
        Page<Course> courses = courseRepository
                .findByTitleContainingIgnoreCaseAndLanguageCodeAndIsDeletedFalse(title, languageCode, pageable);
