...
//     queryFn: async () => {
//       const response = await instance.get("/api/v1/study-rooms")
...
//     queryFn: async () => {
//       const response = await instance.get(`/api/v1/quiz-questions?topic=${currentRoom?.topic}`)
...
//       const response = await instance.post("/api/v1/study-rooms", roomData)
...
//       showToast({message: t("room.created")})
//       queryClient.invalidateQueries({ queryKey: ["study-rooms"] })
//     },
//     onError: (error) => {
//       showToast({message :t("error.createRoom")})
//     },
//   })
...
//       const response = await instance.post(`/api/v1/study-rooms/${roomId}/join`)
//       return response.data
//     },
//     onSuccess: (data) => {
//       setCurrentRoom(data.room)
...
//       showToast(t("room.joined"))
//     },
//     onError: (error) => {
//       showToast(t("error.joinRoom"))
//     },
//   })
...
//       const response = await instance.post(`/api/v1/study-rooms/${roomId}/reactions`, { reaction })
//       return response.data
//     },
//   })
