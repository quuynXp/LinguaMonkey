...
//   const { data: itemDetail, isLoading, error, mutate: mutateDetail } = useRoadmapItemDetail(itemId)
//   const { startItem, isStarting } = useStartRoadmapItem()
//   const { completeItem, isCompleting } = useCompleteRoadmapItem()
...
//               // Navigate to the actual content based on type
...
//           onPress: async () => {
//             try {
//               await completeItem(itemDetail.item.id)
