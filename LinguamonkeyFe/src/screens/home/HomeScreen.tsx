...
//   // FIX: No language parameter passed here anymore
...
//   // FIX: Refetch data when screen comes into focus
//   useFocusEffect(
//     useCallback(() => {
//       refetchRoadmaps();
...
import type { UserDailyChallengeResponse } from "../../types/dto";
import { createScaledSheet } from "../../utils/scaledStyles";
// import HomeCarousel from "../../components/home/HomeCarousel"; // ĐÃ XÓA
import HomeSinglePromotion from "../../components/home/HomeSinglePromotion"; // ĐÃ THÊM
import RoadmapTimeline from "../../components/roadmap/RoadmapTimeline";
import RoadmapSkeleton from "../../components/common/RoadmapSkeleton";
    ...
    <ScreenLayout backgroundColor="#F8FAFC" swipeToTab="Chat">
      ...
      >
        <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
          ...
          <HomeSinglePromotion navigation={navigation} /> {/* Sử dụng component mới */}
