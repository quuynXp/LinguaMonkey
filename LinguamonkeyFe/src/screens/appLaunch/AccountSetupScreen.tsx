...
const AccountSetupScreen = ({ navigation }) => {
  ...
  const handleCompleteSetup = async () => {
    try {
      ...
      console.log("Creating account with setup data:", setupData)
      Alert.alert("Welcome!", "Your account has been created successfully!", [
        { text: "Get Started", onPress: () => navigation.navigate("DailyWelcome") },
      ])
    } catch (error) {
        ...
        <View style={styles.languagesGrid}>
          {languages.map((lang) => (
            <TouchableOpacity
              ...
              onPress={() => setSetupData({ ...setupData, nativeLanguage: lang.code })}
            >
        ...
        <View style={styles.languagesGrid}>
          {languages.map((lang) => (
            <TouchableOpacity
              ...
              onPress={() =>
                toggleArraySelection(setupData.targetLanguages, lang.code, (arr) =>
                  setSetupData({ ...setupData, targetLanguages: arr }),
                )
              }
            >
              <Text style={styles.languageFlag}>{lang.flag}</Text>
      ...
      <View style={styles.certificationsList}>
        {certifications.map((cert) => (
          <TouchableOpacity
            ...
            onPress={() =>
              toggleArraySelection(setupData.certifications, cert.id, (arr) =>
                setSetupData({ ...setupData, certifications: arr }),
              )
            }
          >
        ...
        <View style={styles.ageGrid}>
          {["13-17", "18-24", "25-34", "35-44", "45-54", "55+"].map((age) => (
            <TouchableOpacity
              ...
              onPress={() => setSetupData({ ...setupData, ageRange: age })}
            >
      ...
      <View style={styles.interestsGrid}>
        {interests.map((interest) => (
          <TouchableOpacity
            ...
            onPress={() =>
              toggleArraySelection(setupData.interests, interest.id, (arr) =>
                setSetupData({ ...setupData, interests: arr }),
              )
            }
          >
            <Icon
      ...
      <View style={styles.goalsList}>
        {learningGoals.map((goal) => (
          <TouchableOpacity
            ...
            onPress={() =>
              toggleArraySelection(setupData.learningGoals, goal.id, (arr) =>
                setSetupData({ ...setupData, learningGoals: arr }),
              )
            }
          >
      ...
      <View style={styles.paceContainer}>
        {learningPaces.map((pace) => (
          <TouchableOpacity
            ...
            onPress={() => setSetupData({ ...setupData, learningPace: pace.id as any })}
          >
